 ...
 */
public class LeadFollowFragment extends Fragment implements View.OnClickListener {
    View view;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view==null){
            view=inflater.inflate(R.layout.fragment_follow_lead,container,false);
        }
        initViews();
        return view;
    }
    ...
    public void onResume() {
        ...
        ((MainActivity)getActivity()).setBottomNavigation(false,true,false);
